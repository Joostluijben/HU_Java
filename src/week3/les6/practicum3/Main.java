...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("\np1: " +persoon1+ "\n\np2: " +persoon2+ "\n\np3: " +persoon3+ "\n");
		Game zoekGame1 = persoon1.zoekGameOpNaam("Just Cause 3");
		System.out.println("p1 heeft Just Cause 3 " + (zoekGame1 != null ? "wel!" : "niet!"));
		Game zoekGame2 = persoon3.zoekGameOpNaam("Just Cause 3");
		System.out.println("p3 heeft Just Cause 3 " + (zoekGame2 != null ? "wel!" : "niet!"));
	}
}
